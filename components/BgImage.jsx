...
const BgImage = ({ title, button }) => {
  return (
    <>
      <section className="max-container">
        <div className="relative w-full mx-auto overflow-hidden h-[700px] -mt-48">
          <Image
            src={background}
            alt="banner_image"
            className="absolute top-12 inset-0 z-0 min-w-[1200px]"
          />
          ...
          <div className="relative p-1 flex items-center">
            <div className="flex flex-col ml-20 absolute top-80 mt-8 gap-2">
              <div className="flex flex-row">
                ...
                />
                <h1 className="text-white text-6xl font-semibold mt-5 max-w-[732px] tracking-wider leading-tight">
                  {title}
                </h1>
              </div>
